...
def test_create_payment_intent_success(client, monkeypatch):
    ...
    response = client.post('/stripe/create-payment-intent', json={'amount': 50, 'userId': 'user-1'})
...
def test_create_payment_intent_invalid_amount(client):
    response = client.post('/stripe/create-payment-intent', json={'amount': 0, 'userId': 'user-1'})
